...
// Objetos con los métodos del Formulario
...
var mf = {
    ...
    validarFormulario: function() {
        ...
        if (!pf.validarUsuario || !pf.validarPassword || pf.validarEmail) {
            ...
            document.querySelector("#labelEnviar").innerHTML = "<span style='color:red'>¡*Tiene errores en los datos ingresados, favor de revisar de nuevo!</span>";

            return false;
        } else if (!pf.validarTerminos) {

            document.querySelector("#labelEnviar").innerHTML = "<span style='color:red'>¡*Favor Aceptar Terminos y Condiciones!</span>";
